...
def transretinaseg_architecture(input_shape):
    ...
    x = transformer_block(x, num_heads=2, ff_dim=filters[4])
    ...
    model = Model(inputs, outputs, name="TransRetinaSeg_Architecture")
    return model
