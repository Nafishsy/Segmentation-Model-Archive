"""
unetplusplus_atrous.py

UNet++ with Atrous convolutions for retinal vessel segmentation.

- Uses atrous convolutions in the bottleneck for multi-scale feature extraction.
- Suitable for biomedical image segmentation tasks.

Usage:
    from unetplusplus_atrous import unetplusplus_atrous
    model = unetplusplus_atrous(input_shape=(128, 128, 1))
"""
