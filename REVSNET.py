"""
REVSNETPP (Retinal Vessel Segmentation Net++).

- Combines residual connections, atrous convolutions, attention, and SE blocks.
- Suitable for retinal vessel segmentation.

Usage:
    from REVSNET import REVSNET
    model = REVSNET(input_shape=(128, 128, 1))
"""
...
def REVSNET(input_shape, dropout=0.2, batchnorm=True):
