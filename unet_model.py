...
Simple U-Net implementation for retinal vessel segmentation.
...
Usage:
    ...
    model = unetmodel(input_shape=(128, 128, 1))
"""
...
def conv_block(x, kernelsize, filters, dropout, batchnorm=False):
    """
    Convolutional block: Conv2D -> (BatchNorm) -> ReLU -> (Dropout) -> Conv2D -> (BatchNorm) -> ReLU
    Args:
        x: Input tensor.
...
def unetmodel(input_shape, dropout=0.2, batchnorm=True):
    """
    Build a simple U-Net model for image segmentation.
