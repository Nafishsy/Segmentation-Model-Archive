...
Attention U-Net implementation for retinal vessel segmentation.

- Incorporates attention gates in the decoder to focus on relevant features.
- Suitable for biomedical image segmentation tasks.

Usage:
    from attention_unet import attentionunet
    model = attentionunet(input_shape=(128, 128, 1))
"""
