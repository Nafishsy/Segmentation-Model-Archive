...
def mamba_block(x, num_heads=2, ff_dim=64):
...
def segmamba_architecture(input_shape):
    ...
    x = mamba_block(x, num_heads=2, ff_dim=filters[4])
    ...
    model = Model(inputs, outputs, name="SegMamba_Architecture")
    return model
